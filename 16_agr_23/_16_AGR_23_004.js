...
webform.validators.agr16 = function (v, allowOverpass) {
    ...
    for (var i = 1; i <= 1; i++) {
        ...
        if (!isNaN(Number(values["CAP2_R0704_C" + i]))) {
            var R0704_C = Number(values["CAP2_R0704_C" + i]);
        }


        if (!isNaN(Decimal(values["CAP2_R0689_C" + i] || 0)
            .plus(values["CAP2_R0691_C" + i] || 0)
            .plus(values["CAP2_R0693_C" + i] || 0)
            .plus(values["CAP2_R0695_C" + i] || 0)
            .plus(values["CAP2_R0697_C" + i] || 0)
            .plus(values["CAP2_R0699_C" + i] || 0)
            .plus(values["CAP2_R0701_C" + i] || 0)
            .plus(values["CAP2_R0703_C" + i] || 0)



        )) {

            var SUM_34_007 = Decimal(values["CAP2_R0689_C" + i] || 0)
                .plus(values["CAP2_R0691_C" + i] || 0)
                .plus(values["CAP2_R0693_C" + i] || 0)
                .plus(values["CAP2_R0695_C" + i] || 0)
                .plus(values["CAP2_R0697_C" + i] || 0)
    ...
    for (var i = 1; i <= 1; i++) {
        ...
        if (!isNaN(Number(values["CAP2_R0688_C" + i]))) {
            var R0689 = Number(values["CAP2_R0688_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0689_C" + i] || 0))) {
            var SUM_34_008 = Decimal(values["CAP2_R0689_C" + i] || 0);
        }
        if (R0689 > 0 && SUM_34_008 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0688_C' + i,
                'weight': 8,
        ...
        if (!isNaN(Number(values["CAP2_R0690_C" + i]))) {
            var R0690 = Number(values["CAP2_R0690_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0691_C" + i] || 0))) {
            var SUM_34_009 = Decimal(values["CAP2_R0691_C" + i] || 0);
        }
        if (R0690 > 0 && SUM_34_009 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0690_C' + i,
                'weight': 9,
        ...
        if (!isNaN(Number(values["CAP2_R0692_C" + i]))) {
            var R0692 = Number(values["CAP2_R0692_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0693_C" + i] || 0))) {
            var SUM_34_010 = Decimal(values["CAP2_R0693_C" + i] || 0);
        }
        if (R0692 > 0 && SUM_34_010 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0692_C' + i,
                'weight': 10,
        ...
        if (!isNaN(Number(values["CAP2_R0694_C" + i]))) {
            var R0694 = Number(values["CAP2_R0694_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0695_C" + i] || 0))) {
            var SUM_34_011 = Decimal(values["CAP2_R0695_C" + i] || 0);
        }
        if (R0694 > 0 && SUM_34_011 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0694_C' + i,
                'weight': 11,
        ...
        if (!isNaN(Number(values["CAP2_R0696_C" + i]))) {
            var R0696 = Number(values["CAP2_R0696_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0697_C" + i] || 0))) {
            var SUM_34_012 = Decimal(values["CAP2_R0697_C" + i] || 0);
        }
        if (R0696 > 0 && SUM_34_012 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0696_C' + i,
                'weight': 12,
        ...
        if (!isNaN(Number(values["CAP2_R0698_C" + i]))) {
            var R0698 = Number(values["CAP2_R0698_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0699_C" + i] || 0))) {
            var SUM_34_013 = Decimal(values["CAP2_R0699_C" + i] || 0);
        }
        if (R0698 > 0 && SUM_34_013 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0698_C' + i,
                'weight': 13,
        ...
        if (!isNaN(Number(values["CAP2_R0700_C" + i]))) {
            var R0700 = Number(values["CAP2_R0700_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0701_C" + i] || 0))) {
            var SUM_34_014 = Decimal(values["CAP2_R0701_C" + i] || 0);
        }
        if (R0700 > 0 && SUM_34_014 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0700_C' + i,
                'weight': 14,
        ...
        if (!isNaN(Number(values["CAP2_R0702_C" + i]))) {
            var R0702 = Number(values["CAP2_R0702_C" + i]);
        }
        if (!isNaN(Decimal(values["CAP2_R0703_C" + i] || 0))) {
            var SUM_34_015 = Decimal(values["CAP2_R0703_C" + i] || 0);
        }
        if (R0702 > 0 && SUM_34_015 == 0) {
            webform.errors.push({
                'fieldName': 'CAP2_R0702_C' + i,
                'weight': 15,
